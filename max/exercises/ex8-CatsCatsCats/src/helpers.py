...
def preprocess_one_cat(data_dir="data/"):
    src = f"{data_dir}MissingCat"
    dst = f"{data_dir}ModelCat"
    out = f"{data_dir}MissingCatProcessed.jpg"
